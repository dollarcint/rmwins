...
NEW_CODES = {"organization.action.delete_unit"}


def seed_organization_delete_permission(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [("accounts", "0014_seed_client_integration_permissions")]
    operations = [migrations.RunPython(seed_organization_delete_permission, migrations.RunPython.noop)]
